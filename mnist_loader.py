...
def load_data(path="/home/maksiu/neural-networks-and-deep-learning/data/mnist.pkl.gz"):
...
def load_data_wrapper(path="/home/maksiu/neural-networks-and-deep-learning/data/mnist.pkl.gz"):
